...
![image](https://github.com/YangLuchao/img_host/raw/master/root/image.6nw71twyqrk0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/root/image.2axg0vizhts0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/root/image.5ykbjn8yalo0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/root/image.4nmz21cgg1k0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/root/image.67gix908xww0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/root/image.5g33ivpq0bc0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.618835oi5i40.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.4trtttaq7to0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.5vxsmoc2elo0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.5qf6ym96gr40.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.1kjuwbcs9068.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.31gqqsfj3ms0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.31q71accnuc0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.79k4nhrr0wc0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.iiip3c5cluo.webp)

### 出栈操作

出栈（POP)操作从堆栈顶端移走一个值并将其复制到寄存器或内存变量中，在值从栈顶弹出之后，堆栈指针相应增加，并指向栈中与弹出数据相邻的高位置。图5.4显示了在数值00000002出栈前后堆栈的变化。

![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.6yfoc9p7cks0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.54pe0dt6v9o0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.43l8dif54lg0.webp)

Sub3过程结束的时执行RET指令，从堆栈中弹出[ESP]处的值送指令指针寄存器，这将使得CPU从紧跟调用Sub3之后的指令处恢复执行，下图显示了在从Sub3过程返回之前的堆栈状况：

![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.1hik9xr2xzfk.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.79o9j33w3ac0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.4uevaegkv440.webp)

像“是”或“否”这样的文本被加到判断符号旁边以显示分支方向，与判断符号相连的箭头的位置没有特殊的要求。每个步骤符号中可以包含一个或多个紧密相关的指令，指令不必符合标准的语法。例如，CX加1就可以使用下面两种符号的任意一种：

![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.p15q67i7780.webp)

让我们为上节的ArraySum过程设计一个简单的流程图，结果如图5.9所示。注意图中对LOOP指令使用了判断符号，因为LOOP指令必须决定是否把控制转移到标号处（依据CX的值）。流程图的右边给出了原始的程序清单。

![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.5tgahrzipzs0.webp)
...
![image](https://github.com/YangLuchao/img_host/raw/master/20230223/image.2t863fgbwg40.webp)
